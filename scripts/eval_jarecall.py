...
Usage:
    python3 scripts/eval_jarecall.py eval_out.json          # full run
    SLICE=12 python3 scripts/eval_jarecall.py eval_out.json # 12 cases, then exit
    MODE=plain ITERS=3 python3 scripts/eval_jarecall.py plain_out.json
