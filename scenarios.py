...
hotel_tasks = [
    ...
    Task("Use the word 'housekeeping'",
         "Housekeeping means the hotel staff and service that cleans the rooms. You need information. Ask for housekeeping to clean the room.", "Learner used the word 'housekeeping'."),
