...
# Read python code from scratch/sc0_fixed.py
with open('scratch/sc0_fixed.py') as f:
    code = f.read()

local_vars = {'Task': Task}
exec(code, local_vars)
tasks = local_vars['scenario_0_tasks']

sc = Scenario("Fine Dining Restaurant", "Restaurant", "Waiter", "Learner", tasks)
...
print(f"Scenario 1 checks: PASS={sc_passed}")
