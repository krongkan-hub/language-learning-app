...
with open('scratch/sc4_fixed.py') as f:
    code = f.read()

local_vars = {'Task': Task}
exec(code, local_vars)
tasks = local_vars['scenario_4_tasks']

sc = Scenario("Hotel Check-in", "Hotel", "Receptionist", "Learner", tasks)
...
print(f"Scenario 5 checks: PASS={sc_passed}")
