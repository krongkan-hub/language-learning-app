...
with open('scratch/sc2_fixed.py') as f:
    code = f.read()

local_vars = {'Task': Task}
exec(code, local_vars)
tasks = local_vars['scenario_2_tasks']

sc = Scenario("Coffee Shop", "Coffee Shop", "Barista", "Learner", tasks)
...
print(f"Scenario 3 checks: PASS={sc_passed}")
